...
// Source: https://raw.githubusercontent.com/aurelia/validation/master/dist/aurelia-validation.d.ts
...
* Validation triggers.
*/
export const validateTrigger: any;
export function getPropertyInfo(expression?: any, source?: any): any;

/**
* Decorator: Indicates that the decorated class/object is a validation-renderer.
*/
export const validationRenderer: Function;
...
declare module 'aurelia-validation/dist/aurelia-validation' {
export * from '~aurelia-validation/dist/aurelia-validation';
}
